...
def test_missing_optional_sdk_uses_focused_error(
    ...
    monkeypatch.setattr("slidelineage.ai_schema.importlib.import_module", missing_sdk)
    with pytest.raises(AiSdkUnavailableError, match=r"\[ai\]"):

...
class _StructuredResponse(Protocol):
    """Typed subset of an OpenAI structured response used by this module."""
...
class _ResponsesClient(Protocol):
    """Typed subset of ``client.responses`` used for dependency injection."""

    def parse(self, **kwargs: object) -> _StructuredResponse: ...


class _OpenAiClient(Protocol):
    """Minimal client surface shared by the SDK and network-free test doubles."""

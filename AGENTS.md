...
- Preserve evidence provenance for every finding. Future ingestion and detector work must preserve raw source provenance, retain zero-based data-row provenance, and avoid recomputing manifest digests from decoded text.
...
- Keep semantic interpretation out of the ingestion layer; reject normalized header collisions instead of guessing aliases.
